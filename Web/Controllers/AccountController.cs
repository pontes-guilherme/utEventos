...
namespace Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Register([Bind(Include = "nome,email,senha,data_nascimento,tipo")] Usuario usuario)
        {
            ...
            //System.Diagnostics.Debug.WriteLine(usuario.senha);
            //System.Diagnostics.Debug.WriteLine(usuario.tipo);
            //System.Diagnostics.Debug.WriteLine(usuario.data_nascimento);
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    //usuario.senha = pnUsuarios.CreateMD5(usuario.senha);
